...
El diseño usa la identidad existente de la aplicación: morado `#6658f5`, lavanda `#c9c2ff`, papel `#f7f5ef`, tinta `#20263a` y nota amarilla `#ffe58f`. La estructura se basa en tablas, mantiene estilos esenciales en línea, no usa JavaScript ni imágenes externas y añade una adaptación discreta para modo oscuro.
